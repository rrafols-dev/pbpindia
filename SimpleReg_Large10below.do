...
foreach x in "2" {
	...
	capture noi `m1'
	outreg2 using "$outreg\RD`x'_DistCl_Elgible_L10.xls", replace ctitle("Model 1") label drop(_Istate* _Iindustry*)
		forval i=2/6 { 
			`m`i''
			outreg2 using "$outreg\RD`x'_DistCl_Elgible_L10.xls", append ctitle("Model `i'") label drop(_Istate* _Iindustry*)			
		}
}
set more off
foreach x in "2" {
	...
	capture noi `m1'
	outreg2 using "$outreg\RD`x'_StateCl_Elgible_L10.xls", replace ctitle("Model 1") label drop(_Istate* _Iindustry*)
		forval i=2/6 { 
			`m`i''
			outreg2 using "$outreg\RD`x'_StateCl_Elgible_L10.xls", append ctitle("Model `i'") label drop(_Istate* _Iindustry*)			
		}
}
*********************
*********************
...
foreach x in "2" {
	...
	local m6 "xi:reg ltot_emp`x' backwarddist w1 w2 w3 i.state91 logarea logpop work_partrate_t literacy_rate_t logag logmanuf logmainwork, cluster(loc_code)"
	capture noi `m1'
	outreg2 using "$outreg\RD`x'_DistCl_Untreatd_L10.xls", replace ctitle("Model 1") label drop(_Istate* _Iindustry*)
		forval i=2/6 { 
			`m`i''
			outreg2 using "$outreg\RD`x'_DistCl_Untreatd_L10.xls", append ctitle("Model `i'") label drop(_Istate* _Iindustry*)			
		}
}
set more off
foreach x in "2" {
	...
	local m6 "xi:reg ltot_emp`x' backwarddist w1 w2 w3 i.state91 logarea logpop work_partrate_t literacy_rate_t logag logmanuf logmainwork, cluster(state91)"
	capture noi `m1'
	outreg2 using "$outreg\RD`x'_StateCl_Untreatd_L10.xls", replace ctitle("Model 1") label drop(_Istate* _Iindustry*)
		forval i=2/6 { 
			`m`i''
			outreg2 using "$outreg\RD`x'_StateCl_Untreatd_L10.xls", append ctitle("Model `i'") label drop(_Istate* _Iindustry*)			
		}
}
...
foreach x in "2" {
	...
	local m6 "xi:reg ltot_emp`x' backwarddist w1 w2 w3  i.state91 logarea logpop work_partrate_t literacy_rate_t logag logmanuf logmainwork, cluster(loc_code)"
	capture noi `m1'
	outreg2 using "$outreg\RD`x'_DistCl_Elgible_B10.xls", replace ctitle("Model 1") label drop(_Istate* _Iindustry*)
		forval i=2/6 { 
			`m`i''
			outreg2 using "$outreg\RD`x'_DistCl_Elgible_B10.xls", append ctitle("Model `i'") label drop(_Istate* _Iindustry*)			
		}
}
set more off
foreach x in "2" {
	...
	local m6 "xi:reg ltot_emp`x' backwarddist w1 w2 w3  i.state91 logarea logpop work_partrate_t literacy_rate_t logag logmanuf logmainwork, cluster(state91)"
	capture noi `m1'
	outreg2 using "$outreg\RD`x'_StateCl_Elgible_B10.xls", replace ctitle("Model 1") label drop(_Istate* _Iindustry*)
		forval i=2/6 { 
			`m`i''
			outreg2 using "$outreg\RD`x'_StateCl_Elgible_B10.xls", append ctitle("Model `i'") label drop(_Istate* _Iindustry*)			
		}
}
*********************
*********************
...
foreach x in "2" {
	...
	local m6 "xi:reg ltot_emp`x' backwarddist w1 w2 w3 i.state91 logarea logpop work_partrate_t literacy_rate_t logag logmanuf logmainwork, cluster(loc_code)"
	capture noi `m1'
	outreg2 using "$outreg\RD`x'_DistCl_Untreatd_B10.xls", replace ctitle("Model 1") label drop(_Istate* _Iindustry*)
		forval i=2/6 { 
			`m`i''
			outreg2 using "$outreg\RD`x'_DistCl_Untreatd_B10.xls", append ctitle("Model `i'") label drop(_Istate* _Iindustry*)			
		}
}
set more off
foreach x in "2" {
	...
	local m6 "xi:reg ltot_emp`x' backwarddist w1 w2 w3 i.state91 logarea logpop work_partrate_t literacy_rate_t logag logmanuf logmainwork, cluster(state91)"
	capture noi `m1'
	outreg2 using "$outreg\RD`x'_StateCl_Untreatd_B10.xls", replace ctitle("Model 1") label drop(_Istate* _Iindustry*)
		forval i=2/6 { 
			`m`i''
			outreg2 using "$outreg\RD`x'_StateCl_Untreatd_B10.xls", append ctitle("Model `i'") label drop(_Istate* _Iindustry*)			
		}
}
